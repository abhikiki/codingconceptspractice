...
public class BuildOrderSolution2 {
    ...
    private void buildProjectOrder(Node node){
        ...
        adjList.get(node.project).clear();
    ...
    public static void main(String[] args) {
        ArrayList<Character> results = new BuildOrderSolution2().buildOrder(
        ...
        char[][] prerequisites
                = { { 'b', 'a' }, { 'c', 'b' }, { 'd', 'c' } };
        results  = new BuildOrderSolution2().buildOrder(numTasks, prerequisites);
        System.out.println("Second Solution=" + results.toString());


        char[][] prerequisitesCycle
                = { { 'b', 'a' }, { 'c', 'b' }, { 'd', 'c' }, {'b','c'} };
        results  = new BuildOrderSolution2().buildOrder(numTasks, prerequisitesCycle);
